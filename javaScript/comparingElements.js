...
//Also note that JavaScript is loosely typed - whichmeans it allows us to mix types in our arrays...
...
//Since we are comparing ahead (to the next element), we need tostop with the last 2 elements
...
if (currentElement == nextElement){
  ...
  if(currentElement !== nextElement){
    ...
    console.log(currentElement + "is" + typeof(nextElement));
  }
}else{
